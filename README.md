...
Check the [releases](https://github.com/droboports/aria2/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/aria2.git
cd aria2
./build.sh
ls -la *.tgz
```
